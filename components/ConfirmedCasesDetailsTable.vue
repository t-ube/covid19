...
.box {
  ...
  &.parent {
    ...
    &::after {
      ...
      border-bottom: $default-bdw solid $red-1;
    }
...
@mixin override($vw, $bdw, $fz, $boxdiff) {
  .group {
    ...
    border-top: px2vw($bdw, $vw) solid $red-1;
    border-left: px2vw($bdw, $vw) solid $red-1;
  }

  .content {
    padding: px2vw(5, $vw) px2vw(10, $vw);
    border: px2vw($bdw, $vw) solid $red-1;
  ...
  .box {
    ...
    &.parent {
      ...
      &::after {
        ...
        border-bottom: px2vw($bdw, $vw) solid $red-1;
      }
